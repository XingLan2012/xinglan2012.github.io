...
- 命令行 → `tools/cmd.md`
- 命令行编译与调试 → `tools/compile-debug.md`
...
- 复杂度简介 → `basic/complexity.md`
- 均摊复杂度 → `basic/amortized-analysis.md`
...
- DP 套 DP → `dp/dp-of-dp.md`
**DP 优化**

- DP 优化简介 → `dp/opt/dp-opt.md`
- 单调队列/单调栈优化 → `dp/opt/monotonic-queue-stack.md`
- 斜率优化 → `dp/opt/slope.md`
- 四边形不等式优化 → `dp/opt/quadrangle.md`
- Slope Trick 优化 → `dp/opt/slope-trick.md`
- WQS 二分 → `dp/opt/wqs-binary-search.md`
...
- 布尔代数 → `math/boolean-algebra.md`
**数字系统**

- 数字系统简介 → `math/numeral-sys/intro.md`
- 进位制 → `math/numeral-sys/base.md`
- 平衡三进制 → `math/numeral-sys/balanced-ternary.md`
- 格雷码 → `math/numeral-sys/gray-code.md`
- 位操作 → `math/bit.md`
...
- 模算术简介 → `math/number-theory/mod-arithmetic.md`
...
- Lagrange 反演 → `math/poly/lagrange-inversion.md`
- 形式幂级数复合|复合逆 → `math/poly/comp-rev.md`
...
- Pólya 计数 → `math/combinatorics/polya.md`
...
- 线性规划基础 → `math/linear-programming.md`
- 单纯形法 → `math/simplex.md`
**抽象代数**

- 基本概念 → `math/algebra/basic.md`
- 群论 → `math/algebra/group-theory.md`
- 环论 → `math/algebra/ring-theory.md`
- 域论 → `math/algebra/field-theory.md`
- Schreier–Sims 算法 → `math/algebra/schreier-sims.md`
**概率论**
...
- 零和游戏 → `math/game-theory/zero-sum-game.md`
...
- 线段树基础 → `ds/seg.md`
- 线段树合并 & 分裂 → `ds/seg-merge-split.md`
- 李超线段树 → `ds/li-chao-tree.md`
- 猫树 → `ds/cat-tree.md`
- 区间最值操作 & 区间历史最值 → `ds/seg-beats.md`
- Kinetic Tournament Tree → `ds/kinetic-tournament-tree.md`
- 划分树 → `ds/dividing.md`
**二叉搜索树 & 平衡树**
...
- 稳定匹配 → `graph/graph-matching/stable-match.md`
...
- 空间优化简介 → `misc/space-optimization.md`
